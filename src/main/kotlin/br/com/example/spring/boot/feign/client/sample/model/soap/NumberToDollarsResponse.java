...
public class NumberToDollarsResponse implements ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            String theNumberToDollarsResult;
            theNumberToDollarsResult = this.getNumberToDollarsResult();
            strategy.appendField(locator, this, "numberToDollarsResult", buffer, theNumberToDollarsResult, (this.numberToDollarsResult!= null));
        }
        return buffer;
    }
