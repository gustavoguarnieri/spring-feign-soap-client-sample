 ...
 * 2022-06-10T02:13:09.299-03:00
 * Generated source version: 3.5.2
 *
 */
@WebServiceClient(name = "NumberConversion",
                  wsdlLocation = "http://localhost/webservicesserver/NumberConversion.wso?wsdl",
...
public class NumberConversion extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost/webservicesserver/NumberConversion.wso?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(NumberConversion.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost/webservicesserver/NumberConversion.wso?wsdl");
        }
        WSDL_LOCATION = url;
    }
