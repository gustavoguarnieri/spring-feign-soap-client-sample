...
public class NumberToWords implements ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            BigInteger theUbiNum;
            theUbiNum = this.getUbiNum();
            strategy.appendField(locator, this, "ubiNum", buffer, theUbiNum, (this.ubiNum!= null));
        }
        return buffer;
    }
